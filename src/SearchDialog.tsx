...
// --- [수정] SearchFilter는 이제 하위 컴포넌트들을 조립만 합니다 ---
...
const SearchFilter = memo(
  ({
    ...
    // 👇 [핵심 수정] 인라인 함수 제거 및 핸들러 캐싱

    // 1. Input (ChangeEvent<HTMLInputElement>)
    ...
    // 2. Select (ChangeEvent<HTMLSelectElement>)
    ...
    // 3. CheckboxGroup (number[]) - GradeCheckboxGroup에서 가공해서 넘겨줌
    ...
    return (
      <Stack spacing={4}>
        <HStack spacing={4}>
          <FormControl>
            ...
            <Input
              ...
              onChange={handleChangeQuery} // ✅ 안정된 핸들러 전달
            />
          </FormControl>
          ...
          <FormControl>
            ...
            <Select
              ...
              onChange={handleChangeCredits} // ✅ 안정된 핸들러 전달
            >
        ...
        <HStack spacing={4}>
          {/* props(grades 배열, onChange 함수)가 모두 변하지 않았으므로 리렌더링 100% 차단 */}
