...
import { useScheduleCommand } from "./ScheduleContext.tsx";
...
const cachedFetchMajors = createCachedFetcher<Lecture[]>(fetchMajors);
const cachedFetchLiberalArts = createCachedFetcher<Lecture[]>(fetchLiberalArts);
